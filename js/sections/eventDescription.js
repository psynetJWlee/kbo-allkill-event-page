...
// js/sections/eventDescription.js
...
;(function(window, $) {
  ...
  function initEventDescriptionSection() {
    ...
    // 대상 컨테이너
    const $container = $('#event-description-section');
    if ($container.length === 0) {
      console.error('[initEventDescriptionSection] #event-description-section not found');
      return;
    }
    ...
    console.log("Event Description Section initialized successfully");
  }
