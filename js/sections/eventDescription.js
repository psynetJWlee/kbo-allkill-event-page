...
function initEventDescriptionSection() {
  ...
  const sectionHtml = `
    ...
    <ul class="info-list">
      <li class="info-item">이벤트 기간 : 8월 21일 ~ 9월 19일</li>
      <li class="info-item">경기의 승리, 무승부를 모두 예측하여 제출</li>
      <li class="info-item">매일 당첨자 n명에게 100/n 만원 지급</li>
      <li class="info-item">1 ~ 2 경기 취소 시 나머지 경기로 올킬 선정</li>
      <li class="info-item">3 경기 취소 시 해당일 이벤트 무효</li>
      <li class="info-item">당일 정상적으로 종료되지 않은 경기는 '경기 취소'</li>
      <li class="info-item">당일 첫 경기 시작전 까지 제출 가능</li>
    ...
    <ul class="info-list">
      <li class="info-item">상금 5만원 초과일 경우 지급신청 가능</li>
      <li class="info-item">당첨자 세금신고를 위해 신분증 사본 제출 필요</li>
      <li class="info-item">상금지급 후 개인정보 즉시 파기</li>
      <li class="info-item">제세공과금 ( 22% ) 선공제 후 지급</li>
      <li class="info-item">다중계정은 당첨 취소 될 수 있음</li>
      <li class="info-item">당첨자명과 예금주명 불일치 시 지급 불가</li>
      <li class="info-item">이벤트 종료 후 미신청 상금은 소멸</li>
      <li class="info-item">( 추후 유사 이벤트 진행 시 이월될 수 있음 )</li>
    </ul>
  `;
