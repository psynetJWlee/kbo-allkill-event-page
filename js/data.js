...
// 3일 전(오늘 - 3) 경기 결과
const day23Results = [
  { id: 0, homeTeam:{name:"LG",logo:teamLogos.LG,votes:3215,winner:true},  awayTeam:{name:"KT",logo:teamLogos.KT,votes:1111,winner:false}, homeScore:-, awayScore:-, status:"경기 취소", correct:false },
